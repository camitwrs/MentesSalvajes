      ...
      {filteredEducadores.length > 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <Accordion
            ...
            selectedKeys={
              activeEducadorId
                ? new Set([activeEducadorId.toString()])
                : new Set()
            }
                          ...
                          <div className="p-4">
                            ...
                            <div className="mt-4 flex flex-col sm:flex-row gap-2">
                              <Button
                                ...
                                onPress={() =>
                                  handleVerDetalle(respuesta.idrespuesta)
                                }
                              >
                              ...
                              <Button
                                ...
                                onPress={() =>
                                  handleVerImagen(respuesta.idrespuesta)
                                }
                              >
